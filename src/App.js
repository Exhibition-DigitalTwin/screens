            ...
            */}
            <Fade in={showLEDs} timeout={{ enter: [(this.state.actualStateFade === 6) ? 2000 : fadeTimeBasicIn], exit: fadeTimeBasicOut }} mountOnEnter={true} unmountOnExit={true}>
              <div className={"ledStrip"}>
                <div id={"led1"} style={{ backgroundColor: ledColor1, opacity: ledOpacity1, boxShadow: '0px 0px '+ledShadowSize1+'px' + ledColor1, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2, top: ledDistanceStartTop }}></div>
                <div id={"led2"} style={{ backgroundColor: ledColor2, opacity: ledOpacity2, boxShadow: '0px 0px '+ledShadowSize2+'px' + ledColor2, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2, top: ledDistanceStartTop+ledDistance }}></div>
                <div id={"led3"} style={{ backgroundColor: ledColor3, opacity: ledOpacity3, boxShadow: '0px 0px '+ledShadowSize3+'px' + ledColor3, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2, top: ledDistanceStartTop+ledDistance*2 }}></div>
                <div id={"led4"} style={{ backgroundColor: ledColor4, opacity: ledOpacity4, boxShadow: '0px 0px '+ledShadowSize4+'px' + ledColor4, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2, top: ledDistanceStartTop+ledDistance*3 }}></div>
                <div id={"led5"} style={{ backgroundColor: ledColor5, opacity: ledOpacity5, boxShadow: '0px 0px '+ledShadowSize5+'px' + ledColor5, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2, top: ledDistanceStartTop+ledDistance*4 }}></div>
                <div id={"led6"} style={{ backgroundColor: ledColor6, opacity: ledOpacity6, boxShadow: '0px 0px '+ledShadowSize6+'px' + ledColor6, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2, top: ledDistanceStartTop+ledDistance*5 }}></div>
                <div id={"led7"} style={{ backgroundColor: ledColor7, opacity: ledOpacity7, boxShadow: '0px 0px '+ledShadowSize7+'px' + ledColor7, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2, top: ledDistanceStartTop+ledDistance*6 }}></div>
                <div id={"led8"} style={{ backgroundColor: ledColor8, opacity: ledOpacity8, boxShadow: '0px 0px '+ledShadowSize8+'px' + ledColor8, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2, top: ledDistanceStartTop+ledDistance*7 }}></div>
                <div id={"led9"} style={{ backgroundColor: ledColor9, opacity: ledOpacity9, boxShadow: '0px 0px '+ledShadowSize9+'px' + ledColor9, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2, top: ledDistanceStartTop+ledDistance*8 }}></div>
                <div id={"led10"} style={{ backgroundColor: ledColor10, opacity: ledOpacity10, boxShadow: '0px 0px '+ledShadowSize10+'px' + ledColor10, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2, top: ledDistanceStartTop+ledDistance*9 }}></div>
                <div id={"led11"} style={{ backgroundColor: ledColor11, opacity: ledOpacity11, boxShadow: '0px 0px '+ledShadowSize11+'px' + ledColor11, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2, top: ledDistanceStartTop+ledDistance*10 }}></div>
                <div id={"led12"} style={{ backgroundColor: ledColor12, opacity: ledOpacity12, boxShadow: '0px 0px '+ledShadowSize12+'px' + ledColor12, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2, top: ledDistanceStartTop+ledDistance*11 }}></div>
                <div id={"led13"} style={{ backgroundColor: ledColor13, opacity: ledOpacity13, boxShadow: '0px 0px '+ledShadowSize13+'px' + ledColor13, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2+ledDistanceAngleSide+2, top: ledDistanceStartTop+ledDistance*11+ledDistanceAngleSide }}></div>
                <div id={"led14"} style={{ backgroundColor: ledColor14, opacity: ledOpacity14, boxShadow: '0px 0px '+ledShadowSize14+'px' + ledColor14, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2+ledDistanceAngleSide*2+4, top: ledDistanceStartTop+ledDistance*11+ledDistanceAngleSide*2 }}></div>
                <div id={"led15"} style={{ backgroundColor: ledColor15, opacity: ledOpacity15, boxShadow: '0px 0px '+ledShadowSize15+'px' + ledColor15, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2+ledDistanceAngleSide*3+6, top: ledDistanceStartTop+ledDistance*11+ledDistanceAngleSide*3 }}></div>
                <div id={"led16"} style={{ backgroundColor: ledColor16, opacity: ledOpacity16, boxShadow: '0px 0px '+ledShadowSize16+'px' + ledColor16, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2+ledDistanceAngleSide*4+8, top: ledDistanceStartTop+ledDistance*11+ledDistanceAngleSide*4 }}></div>
                <div id={"led17"} style={{ backgroundColor: ledColor17, opacity: ledOpacity17, boxShadow: '0px 0px '+ledShadowSize17+'px' + ledColor17, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2+ledDistanceAngleSide*5+10, top: ledDistanceStartTop+ledDistance*11+ledDistanceAngleSide*5 }}></div>
                <div id={"led18"} style={{ backgroundColor: ledColor18, opacity: ledOpacity18, boxShadow: '0px 0px '+ledShadowSize18+'px' + ledColor18, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2+ledDistanceAngleSide*6+12, top: ledDistanceStartTop+ledDistance*11+ledDistanceAngleSide*6 }}></div>
                <div id={"led19"} style={{ backgroundColor: ledColor19, opacity: ledOpacity19, boxShadow: '0px 0px '+ledShadowSize19+'px' + ledColor19, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2+ledDistanceAngleSide*7+14, top: ledDistanceStartTop+ledDistance*11+ledDistanceAngleSide*7 }}></div>
                <div id={"led20"} style={{ backgroundColor: ledColor20, opacity: ledOpacity20, boxShadow: '0px 0px '+ledShadowSize20+'px' + ledColor20, position: 'absolute', height: ledSize, width: ledSize, borderRadius: ledSize/2, left: 940-ledSize/2+ledDistanceAngleSide*8+16, top: ledDistanceStartTop+ledDistance*11+ledDistanceAngleSide*8 }}></div>
              </div>
            </Fade>    
            {/*
